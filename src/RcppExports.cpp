...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(tauTest(arr1, arr2, length));
    return __result;
END_RCPP
}
// gemmFitRcppI
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(gemmFitRcppI(n, betas, data, p, kCor, correction, isTauB));
    return __result;
END_RCPP
}
// genAlg
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(genAlg(metricbeta, nbeta, nsuperelites, p, gens, bestmodels, seedmetric));
    return __result;
END_RCPP
}
